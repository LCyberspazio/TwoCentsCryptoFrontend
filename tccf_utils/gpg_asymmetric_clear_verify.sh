...
clear
dialog --title "Digital ClearSign verification" --clear \
       --msgbox "Verify the authenticity of a digitally signed message" 10 50
...
clear
echo "Verifying..."
gpg --verify $sigfile 2> ~/tccf.cryptdevice.temp.wakawaka
